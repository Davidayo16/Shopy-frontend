      ...
      <header className="header-upper large px-3 ">
        <div className="container-xxl">
          <div className="row align-items-center">
            <div className="col-md-2 col-sm-6 header-logo">
            ...
            <div className="col-md-6 col-sm-12">
              ...
              >
                ...
                />
                <button className="bbn input-group-text" id="basic-addon2">
                  <FaSearch />
                </button>
              </form>
            </div>
            ...
            <div className="col-md-5 col-sm-12 ">
              ...
              >
                <input
                  ...
                  onChange={(e) => setKeyword(e.target.value.trim())}
                />
                <span className="input-group-text bbn" id="basic-addon2">
                  <FaSearch />
                </span>
              </form>
            </div>
            ...
            <div className="col-12">
              <div className="menu-bottom d-flex align-items-center gap-30">
                <div className="menu-links">
                  <div className="d-flex align-items-center gap-30 lin">
