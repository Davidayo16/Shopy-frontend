          ...
          <section className="home-wrapper-3 py-3">
            <div className="container-xxl">
              <div className="row">
                {cate?.map((cat) => {
                  return (
                    <div className="col-12 col-xl-3 col-lg-3 col-sm-4 mb-3 ">
                ...
                <div className="col-12">
                  <div className="services d-flex align-items-center justify-content-between">
                    <div className="d-flex align-items-center gap-15 mt-3 mb-3">
                      ...
                      <div>
                        <h4>Free Shipping</h4>
                        <span className="dim">From all orders over $200</span>
                      </div>
                    </div>
                    <div className="d-flex align-items-center gap-15 mt-3 mb-3 meee">
                      ...
                      <div>
                        ...
                        <span className="dim">Save up to 40% off</span>
                      </div>
                    </div>
                    <div className="d-flex align-items-center gap-15 mt-3 mb-3">
            ...
            <section className="featured-wrapper home-wrapper py-2 mt-0 px-3 amaa">
              <div className="container-xxl">
                <div className="row">
                  {products?.length && (
                    <div className="col-12">
                      <h2 className="section-heading">Buyers choice</h2>
                    </div>
                  )}
